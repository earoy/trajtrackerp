...
def create_numberline(exp_info):
    ...
    common.validate_config_param_type("nl_labels_range", bool, config.nl_labels_range)
    ...
    numberline.labels_range = config.nl_labels_range
    ...
    print(2,numberline.labels_visible, numberline.labels_range)
