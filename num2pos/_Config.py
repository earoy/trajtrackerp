...
class Config(BaseConfig):
    ...
    def __init__(self, experiment_id, data_source, max_movement_time,
                 ...
                 text_target_height=0.6, 
                 text_target_width = 0.6, shuffle_trials=True,
                 ...
                 nl_length=0.9, min_numberline_value=0, max_numberline_value=100, nl_labels_visible=True, nl_labels_range=False,
        ...
        super(Config, self).__init__(
            ...
            text_target_width=text_target_width,
        ...
        self.nl_labels_range = nl_labels_range
