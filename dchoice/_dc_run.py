...
from trajtrackerp.dchoice import TrialInfo, hide_feedback_stimuli, _dc_init
...
def run_trial(exp_info, trial, trial_already_initiated):
    ...
    if 'left_resp_btn.text' in trial.csv_data.keys():
        ...
        if exp_info.config.multiple_response:
            ...
            exp_info.response_buttons[0].text = trial.csv_data['left_resp_btn.text']
            exp_info.response_buttons[1].text = trial.csv_data['right_resp_btn.text']
...
def get_touched_button(exp_info):
    ...
    return None
# ------------------------------------------------
# def update_response_for_trial(exp_info, trial):
#     """
#     Update the response when the trial is initialized

#     :type exp_info: trajtracker.paradigms.common.BaseExperimentInfo
#     :type trial: trajtracker.paradigms.common.BaseTrialInfo
#     """

#     common.update_attr_by_csv_config(exp_info, trial, exp_info.left_resp_text, 'left_resp_btn.text', 'left_resp_text')
#     common.update_attr_by_csv_config(exp_info, trial, exp_info.right_resp_text, 'right_resp_btn.text', 'right_resp_text')
